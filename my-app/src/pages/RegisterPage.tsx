...
import './styles/main.css'; // Создадим этот файл или добавим в main.css
    ...
    return (
        <div className="auth-page-wrapper d-flex align-items-center justify-content-center min-vh-100">
            <Container style={{ maxWidth: '450px' }}>
                {/* Используем класс auth-card для эффекта стекла */}
                <Card className="auth-card shadow-lg border-0 rounded-4">
                    <Card.Body className="p-5">
                        ...
                        <div className="text-center mt-4 auth-footer-text">
                            ...
                            <Link to="/login" className="auth-link fw-bold text-decoration-none">
                                Войти
                            </Link>
                        </div>
                    </Card.Body>
