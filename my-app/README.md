...
Разработанное приложение позволит читатедям создавать и формировать заявки на расчёты вероятности авторства для выбранных ими книг, а библиографам завершать или отклонять данные заявки.
